...
function getStubNews(source?: string | null): NewsArticle[] {
  ...
  const articles: NewsArticle[] = [
    ...
    },
    {
      ...
      summary: "KickStreaming has compiled a list of free official broadcasters showing every World Cup 2026 match. CazéTV streams all 104 matches globally on YouTube.",
      body: null,
      source: "kickstreaming",
      sourceName: "KickStreaming",
      sourceLogoUrl: null,
      author: "KickStreaming",
      imageUrl: null,
      url: "/streams",
      publishedAt: now,
